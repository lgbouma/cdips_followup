...
TESTDICT = {
    ...
    #'HD22879': ['rj59.2010.fits', 5700, 4.50, 120.34], # DROP bc anomalously blue F9 good: all except 14
    #'HD39881': ['rj63.450.fits', 5700, 4.50, 0.32], # G5 DROP - struggles
    'HD101259': ['rj152.901.fits', 5000, 3.50, 96.812], # G6 good: 0-6,8, 9, 10,11,13
    #'WASP-4': ['rj161.506.fits', 5400, 4.50, 58.84], # technically nonstandard, G7 good: 0,2,3,4,5,6, 11. (nb cf did fine?)
    ...
    'HD97101': ['rj185.1188.fits', 4100, 4.50, -16.16], #K8
    'HD199305': ['rj59.1033.fits', 3700, 5.00, -17.144], # M0.5 low vsini
    'GJ686': ['rj59.1274.fits', 3600, 5.00, -9.499], # M1 vsini=2, good: 0-7, 11, 13 (not 10!)
    'HD36395': ['rj318.78.fits', 3700, 5.00, 8.68], # M1.5 good: 0-7, 10,11,13
    'GJ908': ['rj131.1109.fits', 3600, 5.00, -71.084], # M2
    'HD265866': ['rj149.110.fits', 3500, 5.00, 22.942], # M3
    'GJ687': ['rj172.1088.fits', 3400, 5.00, -28.720], # M3.5 vsini=79, 0-8, 11, 13
    'GJ388': ['rj229.80.fits', 3400, 5.00, 12.45], # M4.5 vsini=66, 0-7, 11, 13
    'GJ699': ['rj130.2075.fits', 3200, 5.00, -110.416], # M4 vsini 113.2 Barnard's star!, 0-8, 11, 13
}
