...
def main():
    ...
    ####################
    savstr = '20200213_1m_requests' # eg, 20191207_TOI1098_request_2m_tc_secondary. "ephemupdate" if it is one. (this cancels pending observations)
    overwrite = 1
    validate = 1
    submit = 1

    source_id = '5338645555866749952'
