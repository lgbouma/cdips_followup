...
def main():
    ...
    ##########################################
    # CHANGE BELOW
    savstr = '20210502_fullsemester_2m' # eg, 20191207_TOI1098_request_2m_tc_secondary. "ephemupdate" if it is one. (this cancels pending observations)
    overwrite = 1
    validate = 1
    submit = 1

    tic_id = '234284556' # '120105470'
    ...
    transit_type = 'fulltotals' # see above
    ...
    sites = None # Default None for LCOGT. Could do e.g., 'special' and ['Keck Observatory']
